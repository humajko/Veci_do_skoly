...
function setAction(){
	document.getElementById("frmGet").action = "/sensor/" + document.getElementById('senzorId').value; 
	document.getElementById("frmGet").submit(); 

}

function deleteAction(){
	document.getElementById("frmDelete").action = "/sensor/delete/" + document.getElementById('txtDelete').value; 
